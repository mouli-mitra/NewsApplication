...
import com.news.newsapplication.retrofit.NewsApi
import com.news.newsapplication.retrofit.NewsDataFromJson
import com.news.newsapplication.retrofit.RetrofitHelper
...
class NewsRepository {
    ...
    fun getNewsApiCall(category: String?): MutableLiveData<List<NewsModel>> {
        ...
        val API_KEY = "a5614a5879594baab2b20610daf7ffd0"
        val call = RetrofitHelper.getInstance().create(NewsApi::class.java)
            .getNews("in", category, API_KEY) //put your api key here
